...
export function Compress() {
  ...
  const handleCompress = async () => {
    ...
    try {
      // 1. Find the selected option based on the active state
      const selected = options.find((opt) => opt.id === level);

      // 2. Call our service with the file and the selected quality value
      ...
      console.error(err);
      alert("Compression failed. The file might be encrypted or too large for the browser.");
    } finally {
    ...
    <div className="max-w-4xl mx-auto py-16 px-4">
      <div className="text-center mb-12">
        ...
        <p className="text-zinc-500 text-lg">
          Trade quality for portability. 100% private.
        </p>
      </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
                  ...
                  >
                    <div
                      className={`w-12 h-12 rounded-xl flex items-center justify-center ${
                        level === opt.id ? "bg-black text-white" : "bg-white/5"
                      }`}
                    >
            ...
            <Button
              ...
              className="w-full h-20 text-xl font-black rounded-[1.5rem] bg-white text-black hover:bg-zinc-200"
            >
              {isProcessing ? (
          ...
          <div className="space-y-6">
            <div className="bg-zinc-900/40 border border-white/5 rounded-[2rem] p-8 backdrop-blur-md">
              <p className="text-[10px] uppercase tracking-widest text-zinc-600 mb-6 font-bold">
                Source File
              </p>
              ...
              <button
                ...
                className="mt-6 text-xs text-zinc-500 hover:text-white underline underline-offset-4"
              >
                Change File
              </button>
            </div>
            ...
            <AnimatePresence>
              {result && (
                <motion.div
                  ...
                  className="bg-emerald-500 rounded-[2rem] p-8 text-black shadow-[0_0_50px_rgba(16,185,129,0.2)]"
                >
